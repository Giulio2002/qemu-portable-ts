...
```
packages/qemu             core TypeScript package (qemu-portable)
...
npm run build        # tsc build of qemu-portable
...
npm run smoke        # resolution, -machine help, qemu-img round-trip
npm run smoke:boot   # boots real guests (self-generated payloads) to serial BOOT-OK
```
